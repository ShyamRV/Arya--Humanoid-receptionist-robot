...
engine.setProperty('voice', voices[1].id)  # Use 0 for David voice, 1 for Mark voice and 2 for Zeera voice .
...
def main():
    ...
    while True:
        ...
        say("Aarryya under charge . Let's complete the formalities . please fill the required details in the register.")
